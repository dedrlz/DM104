...
<!-- fwtable fwsrc="layout.fw.png" fwpage="Página 1" fwbase="index.png" fwstyle="Dreamweaver" fwdocid = "1085286222" fwnested="0" -->
  ...
  <tr>
   <td colspan="14" valign="top"><!-- InstanceBeginEditable name="body" --><?php include "facelike.php" ?> <h1>Loja Virtual !</h1> <br /> Empresa Localizada na cidade de Santa Rita do Sapucai - Minas Gerais. <br />
   A Loja Virtual é uma empresa do ramo de vendas on-line.<!-- InstanceEndEditable --></td>
